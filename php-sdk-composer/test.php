...
$ctx = new SecureNativeContext($token, "79.179.88.157", null, (object)["user-agent" => "Mozilla/5.0 (iPad; U; CPU OS 3_2_1 like Mac OS X; en-us"]);
...
if (isset($_REQUEST["formSent"])) {
    $ver = SecureNative::track(array(
        'event' => EventTypes::LOG_IN,
        'userId' => '30',
        'context' => $ctx, //SecureNativeContext::fromRequest(),
        'userTraits' => (object)[
            'name' => 'Your Name',
