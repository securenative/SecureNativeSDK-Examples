...
class EventsController < ApplicationController
  ...
  def verify
    ...
    event_options = SecureNative::EventOptions.new(event: SecureNative::EventTypes::LOG_IN, user_id: 'verify0.1.30', context: context,
                                                   user_traits: SecureNative::UserTraits.new(name: 'verify-0.1.30', email: 'verify0.1.30@verify.com', phone: '+1234567890'))
  ...
  def track
    ...
    context = securenative.from_http_request(request)
    event_options = SecureNative::EventOptions.new(event: SecureNative::EventTypes::LOG_IN, user_id: '0.1.38', context: context,
                                                   user_traits: SecureNative::UserTraits.new(name: 'version-0.1.38', email: 'version@version.com', phone: '+1234567890'),
